...
create index if not exists idx_books_author_address on public.books(author_address);
create index if not exists idx_books_created_at on public.books(created_at desc);
create index if not exists idx_books_content_fingerprint on public.books(content_fingerprint);
