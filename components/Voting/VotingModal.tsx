      ...
      <div className="voting-modal-panel relative z-10 my-auto w-full max-w-4xl overflow-hidden rounded-[1.5rem] border border-yellow-400/20 bg-[radial-gradient(circle_at_top_right,rgba(245,166,35,0.18),transparent_30%),radial-gradient(circle_at_bottom_left,rgba(0,212,255,0.1),transparent_34%),linear-gradient(180deg,rgba(8,10,16,0.98),rgba(3,5,9,0.99))] shadow-[0_32px_90px_rgba(0,0,0,0.68)] sm:rounded-[2rem] sm:shadow-[0_40px_120px_rgba(0,0,0,0.72)]">
        ...
        <div className="sticky top-0 z-10 flex items-start justify-between gap-3 border-b border-white/8 bg-[linear-gradient(180deg,rgba(8,10,16,0.98),rgba(8,10,16,0.92))] px-4 py-3 backdrop-blur-xl sm:items-center sm:px-5 sm:py-4 md:px-6">
          ...
          <div className="min-w-0">
            ...
            <h2 className="mt-1 max-w-[16ch] text-lg font-semibold leading-tight text-slate-50 sm:max-w-none sm:text-xl md:text-2xl">
              {t('title')}
            </h2>
          </div>
          <button
        ...
        <div className="max-h-[calc(100dvh-1.5rem)] overflow-y-auto p-4 sm:max-h-[calc(100dvh-2.5rem)] sm:p-5 md:max-h-[calc(100dvh-6rem)] md:grid md:grid-cols-[minmax(0,1.06fr)_minmax(0,0.94fr)] md:gap-5 md:p-6">
          <div>
            <p className="max-w-2xl whitespace-pre-line text-[0.95rem] leading-6 text-slate-300 md:text-base md:leading-7">
              {t('description')}
            </p>
          ...
          <div className="mt-4 flex flex-col gap-4 md:mt-0">
            <div className="rounded-[1.5rem] border border-cyan-400/15 bg-cyan-400/10 p-4 sm:rounded-3xl sm:p-5">
              <p className="text-xs uppercase tracking-[0.18em] text-cyan-100/80">{t('rewardKicker')}</p>
              <p className="mt-3 text-2xl font-semibold text-slate-50">{t('rewardTitle')}</p>
              <p className="mt-2 text-sm leading-6 text-cyan-50/90">{t('rewardDescription')}</p>
            </div>

            <div className="rounded-[1.5rem] border border-white/10 bg-white/5 p-4 shadow-[0_20px_48px_rgba(0,0,0,0.28)] sm:rounded-3xl sm:p-5">
