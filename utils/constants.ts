...
export const CONTRACT_ABI = [
    ...
    outputs: [
      {
        ...
        internalType: "struct RICOMATRIXV2.ReaderSummary",
        name: "s",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "bool", name: "existsV2", type: "bool" },
      { internalType: "bool", name: "migrated", type: "bool" },
      { internalType: "bool", name: "fullImported", type: "bool" },
      { internalType: "bool", name: "existsV1", type: "bool" },
      { internalType: "uint256", name: "legacySnap", type: "uint256" },
      { internalType: "uint256", name: "legacyClaimable", type: "uint256" },
      { internalType: "uint256", name: "v2RoyaltyAvail", type: "uint256" },
    ],
    stateMutability: "view",
    type: "function",
  },
